...
--nb_carte = (select count(id_carte) from passage);
...
--triggers 3 et 4
insert into type_forfait values(25,'journée',20,'10:00:00',':13:00:00',1);
...
insert into passage values(7001,2,'2020-11-22 16:21:43.28');
